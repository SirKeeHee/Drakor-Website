...
import brImages from "../assets/images/RomanticComedy/BR.jpg";
...
const RomanticComedy = () => {
  return (
    <div>
      <Container>
        <br />
        <h1 className="text-dark">ROMANTIC COMEDY</h1>
        <br />
        <Row>
          <Col md={4} className="drakorWrapper" id="romanticcomedy">
            <Card className="drakorImage">
              <Image
                src={brImages}
                alt="Backstreet Rookie"
                className="images"
              />
          ...
          <Col md={4} className="drakorWrapper">
            <Card className="drakorImage">
              <Image
                src={wwwskImages}
                alt="What's Wrong With Secretary Kim"
                className="images"
              />
              <div className="bg-dark ">
                <div className="p-2 m-1 text-white">
